...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h3 class="font-weight-bold">New Payment</h3>
                ...
                <div class="row mt-3 mb-5">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select required type="text" class="form-control" id="payment_type_id" name="payment_type_id">
                                ...
                                <option value="{{ $pt->id }}">{{ $pt->payment_type_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" id="amount" placeholder="Ex. 100000 (Money) or 10 (rice in Kg)" name="amount" step="any">
