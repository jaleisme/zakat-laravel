...
<div class="container">
    <div class="row my-3">
        <div class="col-12">
            <h3 class="font-weight-bold">Zakat <span>Fitrah</span></h3>
