        ...
        <div class="col-12">
            <form action="{{ route('distribution.update', $distribution->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input required type="number" min="0" class="form-control" id="amount_money" placeholder="Money currency is rupiah" name="amount_money" value="{{ $distribution->amount_money }}">
                </div>
                <div class="form-group">
                    <label for="amount_rice">Amount Rice</label>
                    <input required type="number" min="0" class="form-control" id="amount_rice" placeholder="Weight is in Kilogram" name="amount_rice" value="{{ $distribution->amount_rice }}">
                </div>
                <div class="form-group">
